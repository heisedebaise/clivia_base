...
class QrCode {
  static void show(String content, {ImageProvider? image}) {
    PageRouter.push(QrCodePage(content, image: image));
  }

  static Future<String?> scan() => PageRouter.push(const QrScanerPage());
}
